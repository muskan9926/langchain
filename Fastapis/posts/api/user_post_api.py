...
class UserRequestsPostAPI(APIResponse):
    """
    ...
    def __validate_request(self) -> bool:
        ...
        try:
            ...
            self.session_id = self.request.get("session_id")
    ...
    def db_insert(self):
        try:
            ...
            default_logger.exception("Error during DB insertion: "+ self.session_id + " | " + str(self.db_insert.retry.statistics))
            raise Exception("Error during DB insertion: "+ self.session_id + " | " + str(self.db_insert))
